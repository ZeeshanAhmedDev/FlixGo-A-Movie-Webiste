						...
						<div class="row">
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
								<div class="card__content">
									...
									<ul class="card__meta">
										<li><span>Genre:</span> <a href="#">
											
										<?php
										$sql1 = "SELECT * FROM movies2directors where movieid=".$id;
										...
										<li><span>Director(s):</span> 
										
										
										<?php 
										$sql2 = "SELECT * FROM directors where directorid=".$row1["directorid"];
										$result2 = mysqli_query($conn, $sql2);
										...
										if (mysqli_num_rows($result2) > 0) {
											...
											while($row2 = mysqli_fetch_assoc($result2)) {
											?>
											<a href="?director=<?php echo $row1["directorid"]?>">
									...
									<?php }} ?>
										...
										<li><span>Release year:</span> <?php echo  $row["year"];?></li>
